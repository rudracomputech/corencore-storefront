(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const n of i)if(n.type==="childList")for(const u of n.addedNodes)u.tagName==="LINK"&&u.rel==="modulepreload"&&s(u)}).observe(document,{childList:!0,subtree:!0});function a(i){const n={};return i.integrity&&(n.integrity=i.integrity),i.referrerPolicy&&(n.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?n.credentials="include":i.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(i){if(i.ep)return;i.ep=!0;const n=a(i);fetch(i.href,n)}})();function b(r,e,a){const s=[{code:"USD",symbol:"$",rate:1},{code:"EUR",symbol:"€",rate:.92},{code:"GBP",symbol:"£",rate:.79},{code:"INR",symbol:"₹",rate:83.5},{code:"CAD",symbol:"CA$",rate:1.36},{code:"AUD",symbol:"AU$",rate:1.52}],i=e.cart.reduce((o,d)=>o+d.quantity,0);r.innerHTML=`
  ...
  `,r.querySelector("#currency-switcher").addEventListener("change",o=>{a.setCurrency(o.target.value)}),r.querySelector("#cart-drawer-toggle-btn").addEventListener("click",()=>{a.toggleCart(!0)}),r.querySelector("#open-admin-hub-btn").addEventListener("click",()=>{a.openAdminHub()}),r.querySelector("#header-search-btn").addEventListener("click",()=>{const o=prompt("Search Mother & Baby products (e.g. belly butter, baby wash, lavender, diaper cream):");if(o!==null){a.searchProducts(o);const d=document.getElementById("product-grid-container");d&&d.scrollIntoView({behavior:"smooth"})}}),r.querySelectorAll("[data-filter]").forEach(o=>{o.addEventListener("click",d=>{d.preventDefault();const l=o.getAttribute("data-filter");a.setCategoryFilter(l);const c=document.getElementById("product-grid-container");c&&c.scrollIntoView({behavior:"smooth"})})}),r.querySelector("#logo-home-btn").addEventListener("click",o=>{o.preventDefault(),a.setCategoryFilter("all"),window.scrollTo({top:0,behavior:"smooth"})})}function x(r,e,a){r.innerHTML=`
  ...
  `,r.querySelectorAll(".category-card").forEach(s=>{s.addEventListener("click",()=>{const i=s.getAttribute("data-category");e.setCategoryFilter(i);const n=document.getElementById("product-grid-container");n&&n.scrollIntoView({behavior:"smooth"})})})}function $(r,e,a){let s=1,i={stage:"pregnant",concern:"stretch-marks",preference:"butter"};const n=[{step:1,title:"Who are you shopping for today?",subtitle:"Select the stage to help us personalize safe, biocompatible ingredients.",options:[{key:"stage",value:"pregnant",title:"Expecting Mother",desc:"Trimesters 1, 2, or 3 (Prenatal Care)",icon:"🤰"},{key:"stage",value:"postpartum",title:"Postpartum Mother",desc:"4th Trimester recovery & breastfeeding",icon:"🤱"},{key:"stage",value:"newborn",title:"Newborn Infant",desc:"0 to 6 months delicate skin",icon:"👶"},{key:"stage",value:"toddler",title:"Baby & Toddler",desc:"6 months+ active bath & play care",icon:"🍼"}]},{step:2,title:"What is your main skin or care focus?",subtitle:"Our certified herbal formulas target specific developmental milestones.",options:[{key:"concern",value:"stretch-marks",title:"Stretch Marks & Deep Elasticity",desc:"Soothe tight, itchy stretching skin",icon:"✨"},{key:"concern",value:"nursing-comfort",title:"Nursing & Nipple Healing",desc:"100% Ingestion-safe, lanolin-free balm",icon:"💖"},{key:"concern",value:"baby-eczema",title:"Baby Dryness & Eczema",desc:"Tear-free colloidal oat barrier soothing",icon:"🛁"},{key:"concern",value:"sleep-calm",title:"Bedtime Sleep & Colic Relief",desc:"Lavender calming massage and sleep mist",icon:"🌙"}]},{step:3,title:"What texture and finish do you prefer?",subtitle:"All products are 100% non-sticky and fast-absorbing.",options:[{key:"preference",value:"butter",title:"Rich Whipped Body Butters",desc:"Deep 24hr moisture lock",icon:"🧈"},{key:"preference",value:"oil",title:"Silky Cold-Pressed Oils",desc:"Fast penetration with radiant glow",icon:"💧"},{key:"preference",value:"wash-lotion",title:"Gentle Foams & Daily Lotions",desc:"Lightweight everyday hydration",icon:"🧴"},{key:"preference",value:"full-bundle",title:"Complete Complete Care Routine",desc:"Head-to-toe bundle with 15% savings",icon:"🎁"}]}];function u(){return i.stage==="pregnant"||i.concern==="stretch-marks"?{title:"The Ultimate Prenatal Elasticity Routine",desc:"Designed to maximize skin flexibility and lock in cellular moisture from trimester 1 through postpartum.",products:[e.products.find(t=>t.id===0x38d7eccd55b1f)||e.products[0],e.products.find(t=>t.id===0x38d7ecccd8df1)||e.products[1],e.products.find(t=>t.id===0x38d7eccd55b1d)||e.products[5]]}:i.stage==="postpartum"||i.concern==="nursing-comfort"?{title:"The Fourth Trimester Mama Recovery Routine",desc:"Hospital-grade clean soothing formulas for nursing nipples, restorative firming, and perineal recovery.",products:[e.products.find(t=>t.id===0x38d7eccd55b1e)||e.products[2],e.products.find(t=>t.id===0x38d7eccd55b27)||e.products[3],e.products.find(t=>t.id===0x38d7eccd55b18)||e.products[17]]}:i.concern==="sleep-calm"?{title:"The Blissful Baby Sleep & Calming Ritual",desc:"Pediatrician-tested nighttime ritual with organic French Lavender to encourage deep, tranquil infant sleep.",products:[e.products.find(t=>t.id===0x38d7eccd55b20)||e.products[7],e.products.find(t=>t.id===0x38d7eccd55b28)||e.products[8],e.products.find(t=>t.id===0x38d7eccd55b23)||e.products[13]]}:{title:"The Pure Newborn Head-to-Toe Starter Routine",desc:"Ultra-mild, tear-free essentials to protect baby's delicate microbiome and natural moisture barrier.",products:[e.products.find(t=>t.id===0x38d7eccd55b20)||e.products[7],e.products.find(t=>t.id===0x38d7eccd55b26)||e.products[9],e.products.find(t=>t.id===0x38d7eccd55b25)||e.products[11]]}}function m(){if(s<=3){const t=n[s-1],o=s/3*100;r.innerHTML=`
      ...
      `,r.querySelectorAll(".quiz-option").forEach(c=>{c.addEventListener("click",()=>{const p=c.getAttribute("data-key"),y=c.getAttribute("data-value");i[p]=y,m()})}),r.querySelector("#quiz-next-btn").addEventListener("click",()=>{s++,m()});const l=r.querySelector("#quiz-prev-btn");l&&l.addEventListener("click",()=>{s--,m()})}else{const t=u(),o=t.products.reduce((l,c)=>l+parseFloat((c==null?void 0:c.price)||0),0),d=(o*.85).toFixed(2);r.innerHTML=`
        <div class="container">
          <div class="quiz-section">
            <div class="quiz-card quiz-result-box">
              ...
              <div class="quiz-bundle-action">
                <div class="bundle-pricing">
                  ...
                  <span class="bundle-price-now">${a.formatPrice(d)}</span>
                  <span class="bundle-price-was">${a.formatPrice(o)}</span>
      ...
      `,r.querySelector("#quiz-retake-btn").addEventListener("click",()=>{s=1,m()}),r.querySelector("#quiz-add-bundle-btn").addEventListener("click",()=>{t.products.forEach(l=>{a.addToCart(l,1)}),a.toggleCart(!0)})}}m()}function S(r,e,a){const s=[{id:"all",label:"All Products (18)"},{id:"mother-care",label:"Mother Skin Care"},{id:"baby-care",label:"Baby Care"},{id:"bundles",label:"Bundles & Gift Sets"}];let i=[...e.products];if(e.activeCategory&&e.activeCategory!=="all"&&(i=i.filter(t=>t.category===e.activeCategory)),e.searchQuery){const t=e.searchQuery.toLowerCase();i=i.filter(o=>o.title.toLowerCase().includes(t)||o.tags.toLowerCase().includes(t)||o.short_description.toLowerCase().includes(t))}e.sortBy==="price-low"?i.sort((t,o)=>parseFloat(t.price)-parseFloat(o.price)):e.sortBy==="price-high"?i.sort((t,o)=>parseFloat(o.price)-parseFloat(t.price)):e.sortBy==="rating"&&i.sort((t,o)=>o.rating-t.rating),r.innerHTML=`
      ...
      <div class="container">
        ...
        `:`
          <div class="products-grid">
            ${i.map(t=>{var l,c;const o=t.image||((l=t.images)==null?void 0:l[0]),d=((c=t.images)==null?void 0:c[1])||o;return`
                <div class="product-card" data-product-id="${t.id}">
                  ...
                  <div class="product-content">
                    ...
                    <div class="product-price-row">
                      <span class="product-price">${a.formatPrice(t.price)}</span>
                      ${t.compare_at_price?`
                        <span class="product-compare-price">${a.formatPrice(t.compare_at_price)}</span>
                      `:""}
                    </div>
  ...
  `,r.querySelectorAll(".filter-tab").forEach(t=>{t.addEventListener("click",()=>{const o=t.getAttribute("data-tab");a.setCategoryFilter(o)})});const n=r.querySelector("#product-sort-select");n&&n.addEventListener("change",t=>{a.setSortBy(t.target.value)});const u=r.querySelector("#clear-search-btn");u&&u.addEventListener("click",()=>{a.searchProducts("")});const m=r.querySelector("#reset-filter-btn");m&&m.addEventListener("click",()=>{a.setCategoryFilter("all"),a.searchProducts("")}),r.querySelectorAll("[data-quickview]").forEach(t=>{t.addEventListener("click",o=>{o.stopPropagation();const d=t.getAttribute("data-quickview"),l=e.products.find(c=>String(c.id)===String(d));l&&a.openProductModal(l)})}),r.querySelectorAll(".product-card").forEach(t=>{t.addEventListener("click",o=>{if(o.target.closest("[data-add-to-cart]"))return;const d=t.getAttribute("data-product-id"),l=e.products.find(c=>String(c.id)===String(d));l&&a.openProductModal(l)})}),r.querySelectorAll(".product-image-box").forEach(t=>{const o=t.querySelector(".product-img"),d=o.getAttribute("data-main"),l=o.getAttribute("data-hover");l&&l!==d&&(t.addEventListener("mouseenter",()=>{o.src=l}),t.addEventListener("mouseleave",()=>{o.src=d}))}),r.querySelectorAll("[data-add-to-cart]").forEach(t=>{t.addEventListener("click",o=>{o.stopPropagation();const d=t.getAttribute("data-add-to-cart"),l=e.products.find(c=>String(c.id)===String(d));l&&(a.addToCart(l,1),a.toggleCart(!0))})})}function w(r,e,a,s){var t,o;if(!e){r.innerHTML="";return}let i=((t=e.variants)==null?void 0:t[0])||{id:1,title:"Standard",price:e.price},n=1,u=e.image||((o=e.images)==null?void 0:o[0]);function m(){r.innerHTML=`
        ...
        <div class="modal-box">
          ...
          <div class="quickview-grid">
            ...
            <div class="quickview-gallery">
              <img src="${u}" alt="${e.title}" class="quickview-main-img" id="quickview-active-img" />
              ...
              ${e.variants&&e.variants.length>1?`
                <div class="variant-options-group">
                  ...
                  <div class="variant-chips">
                    ${e.variants.map(p=>`
                      <button 
                        class="variant-chip ${p.id===i.id?"selected":""}" 
                        data-variant-id="${p.id}"
                      >
                        ${p.title} — ${s.formatPrice(p.price)}
                      </button>
                    `).join("")}
                  </div>
                </div>
    ...
    `;const d=r.querySelector("#product-modal-overlay"),l=r.querySelector("#modal-close-btn"),c=()=>{s.closeProductModal()};l.addEventListener("click",c),d.addEventListener("click",p=>{p.target===d&&c()}),r.querySelectorAll(".thumb-img").forEach(p=>{p.addEventListener("click",()=>{u=p.getAttribute("data-src"),m()})}),r.querySelectorAll(".variant-chip").forEach(p=>{p.addEventListener("click",()=>{const y=parseInt(p.getAttribute("data-variant-id"));i=e.variants.find(f=>f.id===y)||i,m()})}),r.querySelector("#modal-qty-minus").addEventListener("click",()=>{n>1&&(n--,m())}),r.querySelector("#modal-qty-plus").addEventListener("click",()=>{n++,m()}),r.querySelector("#modal-add-cart-btn").addEventListener("click",()=>{s.addToCart(e,n,i),s.closeProductModal(),s.toggleCart(!0)})}m()}function v(r,e,a){const s=e.isCartOpen,i=e.cart.reduce((h,g)=>h+parseFloat(g.price)*g.quantity,0);let n=0;e.appliedPromo==="MOMCARE15"?n=i*.15:e.appliedPromo==="PUREBABY"&&(n=Math.min(10,i));const u=Math.max(0,i-n),m=50,t=Math.min(100,i/m*100),o=Math.max(0,m-i);r.innerHTML=`
    <!-- Overlay -->
    ...
    <div class="cart-drawer ${s?"open":""}">
      ...
      <div class="free-shipping-tracker">
        <div class="free-shipping-text">
          ${o===0?"🎉 You have unlocked <strong>FREE Standard Shipping!</strong>":`Add <strong>${a.formatPrice(o.toFixed(2))}</strong> more for <strong>FREE Shipping!</strong>`}
        </div>
            ...
            <div class="cart-item-details">
              ...
              <div class="cart-item-bottom">
                ...
                <div class="cart-item-price">
                  ${a.formatPrice((parseFloat(h.price)*h.quantity).toFixed(2))}
                </div>
              </div>
            </div>
      ...
      ${e.cart.length>0?`
        <div class="cart-footer">
          ...
          <div class="cart-summary-row">
            <span>Subtotal</span>
            <span>${a.formatPrice(i.toFixed(2))}</span>
          </div>

          ${n>0?`
            <div class="cart-summary-row" style="color: var(--color-accent); font-weight: 700;">
              <span>Promo Discount (${e.appliedPromo})</span>
              <span>-${a.formatPrice(n.toFixed(2))}</span>
            </div>
          `:""}

          <div class="cart-summary-row">
            <span>Estimated Shipping</span>
            <span>${o===0?"FREE":a.formatPrice("4.99")}</span>
          </div>

          <div class="cart-total-row">
            <span>Total</span>
            <span>${a.formatPrice((u+(o===0?0:4.99)).toFixed(2))}</span>
          </div>
  ...
  `;const d=r.querySelector("#cart-drawer-overlay"),l=r.querySelector("#cart-close-btn"),c=()=>a.toggleCart(!1);d&&d.addEventListener("click",c),l&&l.addEventListener("click",c);const p=r.querySelector("#cart-start-shopping-btn");p&&p.addEventListener("click",()=>{c();const h=document.getElementById("product-grid-container");h&&h.scrollIntoView({behavior:"smooth"})}),r.querySelectorAll("[data-cart-minus]").forEach(h=>{h.addEventListener("click",()=>{const g=h.getAttribute("data-cart-minus");a.updateCartQuantity(g,-1)})}),r.querySelectorAll("[data-cart-plus]").forEach(h=>{h.addEventListener("click",()=>{const g=h.getAttribute("data-cart-plus");a.updateCartQuantity(g,1)})}),r.querySelectorAll("[data-cart-remove]").forEach(h=>{h.addEventListener("click",()=>{const g=h.getAttribute("data-cart-remove");a.removeFromCart(g)})});const y=r.querySelector("#promo-apply-btn"),f=r.querySelector("#promo-code-input");y&&f&&y.addEventListener("click",()=>{const h=f.value.trim().toUpperCase();h==="MOMCARE15"||h==="PUREBABY"?a.applyPromo(h):h===""?a.applyPromo(""):alert("Invalid promo code. Try 'MOMCARE15' for 15% off!")});const B=r.querySelector("#cart-checkout-btn");B&&B.addEventListener("click",()=>{a.proceedToCheckout()})}function q(r){r.innerHTML=`
        ...
        <div class="reviews-grid">
          ${e.map(a=>`
            <div class="review-card">
              ...
              <h4 class="review-title">"${a.title}"</h4>
              <p class="review-body">${a.text}</p>
              
              <div class="review-author">
                <img src="${a.avatar}" alt="${a.author}" class="author-avatar" />
                <div>
                  <div class="author-name">${a.author}</div>
                  <div class="author-meta">
                    <span>✓ Verified Buyer</span> • <span>${a.stage}</span>
                  </div>
                </div>
              </div>
            </div>
  ...
  `,r.querySelector("#guide-newsletter-form").addEventListener("submit",s=>{s.preventDefault(),alert("🎉 Thank you! Your free Mother & Baby Care Routine Guide has been sent to your email."),s.target.reset()}),e.querySelectorAll("[data-footer-filter]").forEach(s=>{s.addEventListener("click",i=>{i.preventDefault();const n=s.getAttribute("data-footer-filter");a.setCategoryFilter(n);const u=document.getElementById("product-grid-container");u&&u.scrollIntoView({behavior:"smooth"})})}),e.querySelectorAll("[data-footer-nav]").forEach(s=>{s.addEventListener("click",i=>{i.preventDefault();const n=document.getElementById("routine-quiz-container");n&&n.scrollIntoView({behavior:"smooth"})})}),e.querySelectorAll("[data-page]").forEach(s=>{s.addEventListener("click",i=>{i.preventDefault();const n=s.getAttribute("data-page");a.openPageModal(n)})}),e.querySelector("#footer-admin-btn").addEventListener("click",()=>{a.openAdminHub()})}function C(r,e,a){if(!e){r.innerHTML="";return}const s={"routine-guide":{title:"Mother & Baby Care Routine Guide",subtitle:"Gentle, Biocompatible Daily Rituals for Mama and Child",content:`
      ...
      `}},i=s[e]||s["routine-guide"];r.innerHTML=`
  ...
  `;const n=r.querySelector("#page-modal-overlay"),u=r.querySelector("#page-modal-close-btn"),m=r.querySelector("#page-modal-done-btn"),t=()=>a.closePageModal();u&&u.addEventListener("click",t),m&&m.addEventListener("click",t),n&&n.addEventListener("click",o=>{o.target===n&&t()})}function k(r,e,a){if(!e.isAdminHubOpen){r.innerHTML="";return}r.innerHTML=`
