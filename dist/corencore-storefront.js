(function() {
      ...
      <div class="container header-inner">
        ...
        <div class="header-actions">
          ...
          <select class="currency-select" id="currency-switcher">
            ${o.map(i=>`
              <option value="${i.code}" ${e.currency===i.code?"selected":""}>
                ${i.code} (${i.symbol})
              </option>
            `).join("")}
          </select>
  ...
  `,t.querySelector("#currency-switcher").addEventListener("change",i=>{r.setCurrency(i.target.value)}),t.querySelector("#cart-drawer-toggle-btn").addEventListener("click",()=>{r.toggleCart(!0)}),t.querySelector("#open-admin-hub-btn").addEventListener("click",()=>{r.openAdminHub()}),t.querySelector("#header-search-btn").addEventListener("click",()=>{let i=prompt("Search Mother & Baby products (e.g. belly butter, baby wash, lavender, diaper cream):");if(i!==null){r.searchProducts(i);let p=document.getElementById("product-grid-container");p&&p.scrollIntoView({behavior:"smooth"})}}),t.querySelectorAll("[data-filter]").forEach(i=>{i.addEventListener("click",p=>{p.preventDefault();let c=i.getAttribute("data-filter");r.setCategoryFilter(c);let d=document.getElementById("product-grid-container");d&&d.scrollIntoView({behavior:"smooth"})})}),t.querySelector("#logo-home-btn").addEventListener("click",i=>{i.preventDefault(),r.setCategoryFilter("all"),window.scrollTo({top:0,behavior:"smooth"})})}function S(t,e,r){t&&(t.className="storefront-layer layer-header",t.setAttribute("data-layer","header"),T(t,e,r))}function A(t,e,r){t.innerHTML=`
  ...
  `,t.querySelectorAll(".category-card").forEach(o=>{o.addEventListener("click",()=>{let s=o.getAttribute("data-category");e.setCategoryFilter(s);let l=document.getElementById("product-grid-container");l&&l.scrollIntoView({behavior:"smooth"})})})}function F(t,e,r){let o=1,s={stage:"pregnant",concern:"stretch-marks",preference:"butter"},l=[{step:1,title:"Who are you shopping for today?",subtitle:"Select the stage to help us personalize safe, biocompatible ingredients.",options:[{key:"stage",value:"pregnant",title:"Expecting Mother",desc:"Trimesters 1, 2, or 3 (Prenatal Care)",icon:"\u{1F930}"},{key:"stage",value:"postpartum",title:"Postpartum Mother",desc:"4th Trimester recovery & breastfeeding",icon:"\u{1F931}"},{key:"stage",value:"newborn",title:"Newborn Infant",desc:"0 to 6 months delicate skin",icon:"\u{1F476}"},{key:"stage",value:"toddler",title:"Baby & Toddler",desc:"6 months+ active bath & play care",icon:"\u{1F37C}"}]},{step:2,title:"What is your main skin or care focus?",subtitle:"Our certified herbal formulas target specific developmental milestones.",options:[{key:"concern",value:"stretch-marks",title:"Stretch Marks & Deep Elasticity",desc:"Soothe tight, itchy stretching skin",icon:"\u2728"},{key:"concern",value:"nursing-comfort",title:"Nursing & Nipple Healing",desc:"100% Ingestion-safe, lanolin-free balm",icon:"\u{1F496}"},{key:"concern",value:"baby-eczema",title:"Baby Dryness & Eczema",desc:"Tear-free colloidal oat barrier soothing",icon:"\u{1F6C1}"},{key:"concern",value:"sleep-calm",title:"Bedtime Sleep & Colic Relief",desc:"Lavender calming massage and sleep mist",icon:"\u{1F319}"}]},{step:3,title:"What texture and finish do you prefer?",subtitle:"All products are 100% non-sticky and fast-absorbing.",options:[{key:"preference",value:"butter",title:"Rich Whipped Body Butters",desc:"Deep 24hr moisture lock",icon:"\u{1F9C8}"},{key:"preference",value:"oil",title:"Silky Cold-Pressed Oils",desc:"Fast penetration with radiant glow",icon:"\u{1F4A7}"},{key:"preference",value:"wash-lotion",title:"Gentle Foams & Daily Lotions",desc:"Lightweight everyday hydration",icon:"\u{1F9F4}"},{key:"preference",value:"full-bundle",title:"Complete Complete Care Routine",desc:"Head-to-toe bundle with 15% savings",icon:"\u{1F381}"}]}];function u(){return s.stage==="pregnant"||s.concern==="stretch-marks"?{title:"The Ultimate Prenatal Elasticity Routine",desc:"Designed to maximize skin flexibility and lock in cellular moisture from trimester 1 through postpartum.",products:[e.products.find(a=>a.id===0x38d7eccd55b1f)||e.products[0],e.products.find(a=>a.id===0x38d7ecccd8df1)||e.products[1],e.products.find(a=>a.id===0x38d7eccd55b1d)||e.products[5]]}:s.stage==="postpartum"||s.concern==="nursing-comfort"?{title:"The Fourth Trimester Mama Recovery Routine",desc:"Hospital-grade clean soothing formulas for nursing nipples, restorative firming, and perineal recovery.",products:[e.products.find(a=>a.id===0x38d7eccd55b1e)||e.products[2],e.products.find(a=>a.id===0x38d7eccd55b27)||e.products[3],e.products.find(a=>a.id===0x38d7eccd55b18)||e.products[17]]}:s.concern==="sleep-calm"?{title:"The Blissful Baby Sleep & Calming Ritual",desc:"Pediatrician-tested nighttime ritual with organic French Lavender to encourage deep, tranquil infant sleep.",products:[e.products.find(a=>a.id===0x38d7eccd55b20)||e.products[7],e.products.find(a=>a.id===0x38d7eccd55b28)||e.products[8],e.products.find(a=>a.id===0x38d7eccd55b23)||e.products[13]]}:{title:"The Pure Newborn Head-to-Toe Starter Routine",desc:"Ultra-mild, tear-free essentials to protect baby's delicate microbiome and natural moisture barrier.",products:[e.products.find(a=>a.id===0x38d7eccd55b20)||e.products[7],e.products.find(a=>a.id===0x38d7eccd55b26)||e.products[9],e.products.find(a=>a.id===0x38d7eccd55b25)||e.products[11]]}}function n(){if(o<=3){let a=l[o-1],i=o/3*100;t.innerHTML=`
      ...
      `,t.querySelectorAll(".quiz-option").forEach(d=>{d.addEventListener("click",()=>{let h=d.getAttribute("data-key"),v=d.getAttribute("data-value");s[h]=v,n()})}),t.querySelector("#quiz-next-btn").addEventListener("click",()=>{o++,n()});let c=t.querySelector("#quiz-prev-btn");c&&c.addEventListener("click",()=>{o--,n()})}else{let a=u(),i=a.products.reduce((c,d)=>c+parseFloat((d==null?void 0:d.price)||0),0),p=(i*.85).toFixed(2);t.innerHTML=`
        <div class="container">
          <div class="quiz-section">
            <div class="quiz-card quiz-result-box">
              ...
              <div class="quiz-bundle-action">
                <div class="bundle-pricing">
                  ...
                  <span class="bundle-price-was">${r.formatPrice(i)}</span>
      ...
      `,t.querySelector("#quiz-retake-btn").addEventListener("click",()=>{o=1,n()}),t.querySelector("#quiz-add-bundle-btn").addEventListener("click",()=>{a.products.forEach(c=>{r.addToCart(c,1)}),r.toggleCart(!0)})}}n()}function H(t,e,r){let o=[{id:"all",label:"All Products (18)"},{id:"mother-care",label:"Mother Skin Care"},{id:"baby-care",label:"Baby Care"},{id:"bundles",label:"Bundles & Gift Sets"}],s=[...e.products];if(e.activeCategory&&e.activeCategory!=="all"&&(s=s.filter(a=>a.category===e.activeCategory)),e.searchQuery){let a=e.searchQuery.toLowerCase();s=s.filter(i=>i.title.toLowerCase().includes(a)||i.tags.toLowerCase().includes(a)||i.short_description.toLowerCase().includes(a))}e.sortBy==="price-low"?s.sort((a,i)=>parseFloat(a.price)-parseFloat(i.price)):e.sortBy==="price-high"?s.sort((a,i)=>parseFloat(i.price)-parseFloat(a.price)):e.sortBy==="rating"&&s.sort((a,i)=>i.rating-a.rating),t.innerHTML=`
      ...
      <div class="container">
        ...
        `:`
          <div class="products-grid">
            ${s.map(a=>{var c,d;let i=a.image||((c=a.images)==null?void 0:c[0]),p=((d=a.images)==null?void 0:d[1])||i;return`
  ...
  `,t.querySelectorAll(".filter-tab").forEach(a=>{a.addEventListener("click",()=>{let i=a.getAttribute("data-tab");r.setCategoryFilter(i)})});let l=t.querySelector("#product-sort-select");l&&l.addEventListener("change",a=>{r.setSortBy(a.target.value)});let u=t.querySelector("#clear-search-btn");u&&u.addEventListener("click",()=>{r.searchProducts("")});let n=t.querySelector("#reset-filter-btn");n&&n.addEventListener("click",()=>{r.setCategoryFilter("all"),r.searchProducts("")}),t.querySelectorAll("[data-quickview]").forEach(a=>{a.addEventListener("click",i=>{i.stopPropagation();let p=a.getAttribute("data-quickview"),c=e.products.find(d=>String(d.id)===String(p));c&&r.openProductModal(c)})}),t.querySelectorAll(".product-card").forEach(a=>{a.addEventListener("click",i=>{if(i.target.closest("[data-add-to-cart]"))return;let p=a.getAttribute("data-product-id"),c=e.products.find(d=>String(d.id)===String(p));c&&r.openProductModal(c)})}),t.querySelectorAll(".product-image-box").forEach(a=>{let i=a.querySelector(".product-img"),p=i.getAttribute("data-main"),c=i.getAttribute("data-hover");c&&c!==p&&(a.addEventListener("mouseenter",()=>{i.src=c}),a.addEventListener("mouseleave",()=>{i.src=p}))}),t.querySelectorAll("[data-add-to-cart]").forEach(a=>{a.addEventListener("click",i=>{i.stopPropagation();let p=a.getAttribute("data-add-to-cart"),c=e.products.find(d=>String(d.id)===String(p));c&&(r.addToCart(c,1),r.toggleCart(!0))})})}function R(t){t.innerHTML=`
  ...
  `}function w(t,e,r){if(!t)return;t.className="storefront-layer layer-body",t.setAttribute("data-layer","body"),t.querySelector("#hero-container")||(t.innerHTML=`
    ...
    `);let o=t.querySelector("#hero-container"),s=t.querySelector("#trust-bar-container"),l=t.querySelector("#categories-container"),u=t.querySelector("#routine-quiz-container"),n=t.querySelector("#product-grid-container"),a=t.querySelector("#safety-standards-container"),i=t.querySelector("#reviews-container");o&&s&&A(o,s,r),l&&$(l,r),u&&F(u,e,r),n&&H(n,e,r),a&&R(a),i&&I(i)}function z(t,e,r){t.innerHTML=`
    <div class="container">
  ...
  `,t.querySelector("#guide-newsletter-form").addEventListener("submit",o=>{o.preventDefault(),alert("\u{1F389} Thank you! Your free Mother & Baby Care Routine Guide has been sent to your email."),o.target.reset()}),e.querySelectorAll("[data-footer-filter]").forEach(o=>{o.addEventListener("click",s=>{s.preventDefault();let l=o.getAttribute("data-footer-filter");r.setCategoryFilter(l);let u=document.getElementById("product-grid-container");u&&u.scrollIntoView({behavior:"smooth"})})}),e.querySelectorAll("[data-footer-nav]").forEach(o=>{o.addEventListener("click",s=>{s.preventDefault();let l=document.getElementById("routine-quiz-container");l&&l.scrollIntoView({behavior:"smooth"})})}),e.querySelectorAll("[data-page]").forEach(o=>{o.addEventListener("click",s=>{s.preventDefault();let l=o.getAttribute("data-page");r.openPageModal(l)})}),e.querySelector("#footer-admin-btn").addEventListener("click",()=>{r.openAdminHub()})}function D(t,e,r){if(!t)return;t.className="storefront-layer layer-footer",t.setAttribute("data-layer","footer"),t.querySelector("#footer-main-container")||(t.innerHTML=`
      <div id="footer-guide-banner-slot"></div>
      <div id="footer-main-container"></div>
    `);let o=t.querySelector("#footer-guide-banner-slot")||document.getElementById("guide-banner-container")||t,s=t.querySelector("#footer-main-container")||t;z(o,s,r)}function B(t,e,r,o){var a,i;if(!e){t.innerHTML="";return}let s=((a=e.variants)==null?void 0:a[0])||{id:1,title:"Standard",price:e.price},l=1,u=e.image||((i=e.images)==null?void 0:i[0]);function n(){t.innerHTML=`
            ...
            <div class="quickview-info">
              ...
              <div style="display: flex; gap: 14px; align-items: center; margin: 24px 0;">
                ...
                <button class="btn-primary" id="modal-add-cart-btn" style="flex-grow: 1;">
                  <span>\u{1F6D2} Add to Cart \u2022 ${o.formatPrice((parseFloat(s.price||e.price)*l).toFixed(2))}</span>
                </button>
              </div>
    ...
    `;let p=t.querySelector("#product-modal-overlay"),c=t.querySelector("#modal-close-btn"),d=()=>{o.closeProductModal()};c.addEventListener("click",d),p.addEventListener("click",h=>{h.target===p&&d()}),t.querySelectorAll(".thumb-img").forEach(h=>{h.addEventListener("click",()=>{u=h.getAttribute("data-src"),n()})}),t.querySelectorAll(".variant-chip").forEach(h=>{h.addEventListener("click",()=>{let v=parseInt(h.getAttribute("data-variant-id"));s=e.variants.find(C=>C.id===v)||s,n()})}),t.querySelector("#modal-qty-minus").addEventListener("click",()=>{l>1&&(l--,n())}),t.querySelector("#modal-qty-plus").addEventListener("click",()=>{l++,n()}),t.querySelector("#modal-add-cart-btn").addEventListener("click",()=>{o.addToCart(e,l,s),o.closeProductModal(),o.toggleCart(!0)})}n()}function b(t,e,r){let o=e.isCartOpen,s=e.cart.reduce((m,g)=>m+parseFloat(g.price)*g.quantity,0),l=0;e.appliedPromo==="MOMCARE15"?l=s*.15:e.appliedPromo==="PUREBABY"&&(l=Math.min(10,s));let u=Math.max(0,s-l),n=50,a=Math.min(100,s/n*100),i=Math.max(0,n-s);t.innerHTML=`
    <!-- Overlay -->
    ...
    <div class="cart-drawer ${o?"open":""}">
      ...
      <div class="free-shipping-tracker">
        <div class="free-shipping-text">
          ${i===0?"\u{1F389} You have unlocked <strong>FREE Standard Shipping!</strong>":`Add <strong>${r.formatPrice(i.toFixed(2))}</strong> more for <strong>FREE Shipping!</strong>`}
        </div>
            ...
            <div class="cart-item-details">
              ...
              <div class="cart-item-bottom">
                ...
                <div class="cart-item-price">
                  ${r.formatPrice((parseFloat(m.price)*m.quantity).toFixed(2))}
                </div>
              </div>
            </div>
        ...
        <div class="cart-footer">
          ...
          ${l>0?`
            <div class="cart-summary-row" style="color: var(--color-accent); font-weight: 700;">
              ...
              <span>-${r.formatPrice(l.toFixed(2))}</span>
            </div>
          `:""}

          <div class="cart-summary-row">
            <span>Estimated Shipping</span>
            <span>${i===0?"FREE":r.formatPrice("4.99")}</span>
          </div>

          <div class="cart-total-row">
            <span>Total</span>
            <span>${r.formatPrice((u+(i===0?0:4.99)).toFixed(2))}</span>
          </div>
  ...
  `;let p=t.querySelector("#cart-drawer-overlay"),c=t.querySelector("#cart-close-btn"),d=()=>r.toggleCart(!1);p&&p.addEventListener("click",d),c&&c.addEventListener("click",d);let h=t.querySelector("#cart-start-shopping-btn");h&&h.addEventListener("click",()=>{d();let m=document.getElementById("product-grid-container");m&&m.scrollIntoView({behavior:"smooth"})}),t.querySelectorAll("[data-cart-minus]").forEach(m=>{m.addEventListener("click",()=>{let g=m.getAttribute("data-cart-minus");r.updateCartQuantity(g,-1)})}),t.querySelectorAll("[data-cart-plus]").forEach(m=>{m.addEventListener("click",()=>{let g=m.getAttribute("data-cart-plus");r.updateCartQuantity(g,1)})}),t.querySelectorAll("[data-cart-remove]").forEach(m=>{m.addEventListener("click",()=>{let g=m.getAttribute("data-cart-remove");r.removeFromCart(g)})});let v=t.querySelector("#promo-apply-btn"),C=t.querySelector("#promo-code-input");v&&C&&v.addEventListener("click",()=>{let m=C.value.trim().toUpperCase();m==="MOMCARE15"||m==="PUREBABY"?r.applyPromo(m):m===""?r.applyPromo(""):alert("Invalid promo code. Try 'MOMCARE15' for 15% off!")});let M=t.querySelector("#cart-checkout-btn");M&&M.addEventListener("click",()=>{r.proceedToCheckout()})}function k(t,e,r){if(!e){t.innerHTML="";return}let o={"routine-guide":{title:"Mother & Baby Care Routine Guide",subtitle:"Gentle, Biocompatible Daily Rituals for Mama and Child",content:`
      ...
      `}},s=o[e]||o["routine-guide"];t.innerHTML=`
    ...
    <div class="modal-overlay open" id="admin-hub-overlay">
      <div class="modal-box admin-hub-box" style="max-width: 900px; width: 95%;">
        ...
        <div class="admin-hub-header">
          <div class="admin-hub-icon">\u{1F3A8}</div>
          <div>
        ...
        <div class="admin-status-indicator" style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 10px;">
          ...
          >
            \u{1F3A8} Open ShopBase Web Builder \u2197
          </a>
        </div>
          ...
          ${ae.map(i=>`
            <div class="admin-action-card" style="display: flex; flex-direction: column; justify-content: space-between; padding: 14px; background: var(--bg-surface); border: 1px solid var(--color-border); border-radius: var(--radius-md);">
              <div>
                ...
                <h4 style="font-size: 0.95rem; margin-bottom: 4px; font-weight: 700;">${i.title}</h4>
                <p style="font-size: 0.8rem; color: var(--color-text-muted); line-height: 1.4; margin-bottom: 12px;">${i.desc}</p>
              </div>
              <button 
        ...
        <div class="admin-actions-grid" style="grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 12px; padding-top: 14px; border-top: 1px solid var(--color-border);">
          ...
          <button class="btn-secondary" id="btn-sync-pages-action" style="padding: 10px 14px; font-size: 0.85rem;">
            <span>\u{1F4DD} Sync CMS Content Pages</span>
          </button>
        </div>
        <div id="admin-hub-status-log" style="font-size: 0.82rem; margin-top: 8px; font-weight: 600; text-align: center;"></div>
      </div>
    </div>
  `;let o=t.querySelector("#admin-hub-overlay"),s=t.querySelector("#admin-hub-close-btn"),l=()=>r.closeAdminHub();s&&s.addEventListener("click",l),o&&o.addEventListener("click",i=>{i.target===o&&l()}),t.querySelectorAll(".copy-section-btn").forEach(i=>{i.addEventListener("click",async()=>{let p=i.getAttribute("data-file");i.innerHTML="<span>\u23F3 Copying...</span>";try{let c=await fetch(`/api/web-builder/sections/${p}`);if(c.ok){let d=await c.text();await navigator.clipboard.writeText(d),i.innerHTML="<span>\u2705 Copied!</span>",setTimeout(()=>{i.innerHTML="<span>\u{1F4CB} Copy Section HTML</span>"},2500)}else i.innerHTML="<span>\u2705 Section Ready in /web-builder-sections/</span>",setTimeout(()=>{i.innerHTML="<span>\u{1F4CB} Copy Section HTML</span>"},2500)}catch{i.innerHTML="<span>\u2705 Open /web-builder-sections/"+p+"</span>",setTimeout(()=>{i.innerHTML="<span>\u{1F4CB} Copy Section HTML</span>"},2500)}})});let u=t.querySelector("#btn-sync-catalog-action"),n=t.querySelector("#admin-hub-status-log");u.addEventListener("click",async()=>{u.disabled=!0,u.innerHTML="<span>\u23F3 Syncing to ShopBase...</span>",n.style.color="var(--color-primary)",n.textContent="Updating 18 products via Admin REST API...";try{let p=await(await fetch("/api/sync-catalog",{method:"POST"})).json();p.success?(n.style.color="#2E7D32",n.textContent=`\u2705 ${p.message}`,u.innerHTML="<span>\u2713 Synced Successfully</span>"):(n.style.color="#D32F2F",n.textContent=`\u274C ${p.error||"Sync failed"}`,u.innerHTML="<span>Retry Sync</span>",u.disabled=!1)}catch(i){n.style.color="#D32F2F",n.textContent=`\u274C Network Error: ${i.message}`,u.innerHTML="<span>Retry Sync</span>",u.disabled=!1}});let a=t.querySelector("#btn-sync-pages-action");a.addEventListener("click",async()=>{a.disabled=!0,a.innerHTML="<span>\u23F3 Syncing Pages...</span>",n.style.color="var(--color-primary)",n.textContent="Publishing Routine Guide & Clean Safety Standards...";try{let p=await(await fetch("/api/sync-pages",{method:"POST"})).json();p.success?(n.style.color="#2E7D32",n.textContent="\u2705 Pages published to ShopBase store!",a.innerHTML="<span>\u2713 Pages Synced</span>"):(n.style.color="#D32F2F",n.textContent=`\u274C ${p.error||"Pages sync failed"}`,a.innerHTML="<span>Retry Sync</span>",a.disabled=!1)}catch(i){n.style.color="#D32F2F",n.textContent=`\u274C Network Error: ${i.message}`,a.innerHTML="<span>Retry Sync</span>",a.disabled=!1}})}var O={USD:{symbol:"$",rate:1},EUR:{symbol:"\u20AC",rate:.92},GBP:{symbol:"\xA3",rate:.79},INR:{symbol:"\u20B9",rate:83.5},CAD:{symbol:"CA$",rate:1.36},AUD:{symbol:"AU$",rate:1.52}},P=class{constructor(){this.state={products:j.MOTHER_AND_BABY_PRODUCTS,activeCategory:"all",currency:"USD",searchQuery:"",sortBy:"featured",cart:JSON.parse(localStorage.getItem("corencore_cart")||"[]"),isCartOpen:!1,activeModalProduct:null,activePageKey:null,isAdminHubOpen:!1,appliedPromo:localStorage.getItem("corencore_promo")||null,quizStep:1,quizAnswers:{}},this.dom={},this.actions={setCurrency:this.setCurrency.bind(this),formatPrice:this.formatPrice.bind(this),setCategoryFilter:this.setCategoryFilter.bind(this),searchProducts:this.searchProducts.bind(this),setSortBy:this.setSortBy.bind(this),toggleCart:this.toggleCart.bind(this),addToCart:this.addToCart.bind(this),updateCartQuantity:this.updateCartQuantity.bind(this),removeFromCart:this.removeFromCart.bind(this),applyPromo:this.applyPromo.bind(this),proceedToCheckout:this.proceedToCheckout.bind(this),openProductModal:this.openProductModal.bind(this),closeProductModal:this.closeProductModal.bind(this),openPageModal:this.openPageModal.bind(this),closePageModal:this.closePageModal.bind(this),openAdminHub:this.openAdminHub.bind(this),closeAdminHub:this.closeAdminHub.bind(this)}}init(){console.log("\u{1F338} Core & Core 3-Layer Storefront Loaded on Live ShopBase"),this.bindDom(),this.render()}bindDom(){this.dom={layerHeader:document.getElementById("layer-header"),layerBody:document.getElementById("layer-body"),layerFooter:document.getElementById("layer-footer"),cartDrawer:document.getElementById("cart-drawer-root"),productModal:document.getElementById("product-modal-root"),pagesModal:document.getElementById("pages-modal-root"),adminHub:document.getElementById("admin-hub-root")}}setCurrency(e){this.state.currency=e,this.render()}formatPrice(e){let r=parseFloat(e)||0,o=O[this.state.currency]||O.USD,s=(r*o.rate).toFixed(2);return`${o.symbol}${s}`}setCategoryFilter(e){this.state.activeCategory=e,w(this.dom.layerBody,this.state,this.actions),S(this.dom.layerHeader,this.state,this.actions)}searchProducts(e){this.state.searchQuery=e,w(this.dom.layerBody,this.state,this.actions)}setSortBy(e){this.state.sortBy=e,w(this.dom.layerBody,this.state,this.actions)}toggleCart(e){this.state.isCartOpen=e,b(this.dom.cartDrawer,this.state,this.actions)}addToCart(e,r=1,o=null){var n,a;let s=o||((n=e.variants)==null?void 0:n[0])||{id:1,title:"Standard",price:e.price},l=`${e.id}-${s.id}`,u=this.state.cart.findIndex(i=>i.cartItemId===l);u>-1?this.state.cart[u].quantity+=r:this.state.cart.push({cartItemId:l,id:e.id,variantId:s.id,shopbaseHandle:e.shopbase_handle||e.handle,title:e.title,variantTitle:s.title!=="Standard"&&s.title!=="1 PC"?s.title:"",price:s.price||e.price,image:e.image||((a=e.images)==null?void 0:a[0]),quantity:r}),this.saveCart(),S(this.dom.layerHeader,this.state,this.actions),b(this.dom.cartDrawer,this.state,this.actions)}updateCartQuantity(e,r){let o=this.state.cart.find(s=>s.cartItemId===e);if(o&&(o.quantity+=r,o.quantity<=0)){this.removeFromCart(e);return}this.saveCart(),S(this.dom.layerHeader,this.state,this.actions),b(this.dom.cartDrawer,this.state,this.actions)}removeFromCart(e){this.state.cart=this.state.cart.filter(r=>r.cartItemId!==e),this.saveCart(),S(this.dom.layerHeader,this.state,this.actions),b(this.dom.cartDrawer,this.state,this.actions)}saveCart(){localStorage.setItem("corencore_cart",JSON.stringify(this.state.cart))}applyPromo(e){this.state.appliedPromo=e,localStorage.setItem("corencore_promo",e),b(this.dom.cartDrawer,this.state,this.actions)}proceedToCheckout(){if(!this.state.cart.length)return;let e=this.state.cart[0],r=e.shopbaseHandle||e.handle;r?window.location.href=`/products/${r}`:window.location.href="/collections/all"}openProductModal(e){this.state.activeModalProduct=e,B(this.dom.productModal,e,this.state,this.actions)}closeProductModal(){this.state.activeModalProduct=null,B(this.dom.productModal,null,this.state,this.actions)}openPageModal(e){this.state.activePageKey=e,k(this.dom.pagesModal,e,this.actions)}closePageModal(){this.state.activePageKey=null,k(this.dom.pagesModal,null,this.actions)}openAdminHub(){this.state.isAdminHubOpen=!0,x(this.dom.adminHub,this.state,this.actions)}closeAdminHub(){this.state.isAdminHubOpen=!1,x(this.dom.adminHub,this.state,this.actions)}render(){S(this.dom.layerHeader,this.state,this.actions),w(this.dom.layerBody,this.state,this.actions),D(this.dom.layerFooter,this.state,this.actions),b(this.dom.cartDrawer,this.state,this.actions),B(this.dom.productModal,this.state.activeModalProduct,this.state,this.actions),k(this.dom.pagesModal,this.state.activePageKey,this.actions),x(this.dom.adminHub,this.state,this.actions)}};function W(){let t=window.location.pathname.toLowerCase().trim();return t==="/"||t===""||t==="/index.html"}function y(){if(!W())return;if(!document.getElementById("corencore-hide-default")){let e=document.createElement("style");e.id="corencore-hide-default",e.textContent=`
    ...
    `,document.body.prepend(t)),new P().init(),N=!0,y()}function G(){y(),f(),setTimeout(()=>{y(),f()},300),setTimeout(()=>{y(),f()},800),setTimeout(()=>{y(),f()},2e3),window.addEventListener("popstate",()=>{y(),f()}),window.addEventListener("hashchange",()=>{y(),f()})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",G):G();return ee(re);})();
