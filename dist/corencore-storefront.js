(function() {
  ...
  `,a.querySelector("#currency-switcher").addEventListener("change",o=>{i.setCurrency(o.target.value)}),a.querySelector("#cart-drawer-toggle-btn").addEventListener("click",()=>{i.toggleCart(!0)}),a.querySelector("#open-admin-hub-btn").addEventListener("click",()=>{i.openAdminHub()}),a.querySelector("#header-search-btn").addEventListener("click",()=>{let o=prompt("Search Mother & Baby products (e.g. belly butter, baby wash, lavender, diaper cream):");if(o!==null){i.searchProducts(o);let d=document.getElementById("product-grid-container");d&&d.scrollIntoView({behavior:"smooth"})}}),a.querySelectorAll("[data-filter]").forEach(o=>{o.addEventListener("click",d=>{d.preventDefault();let c=o.getAttribute("data-filter");i.setCategoryFilter(c);let n=document.getElementById("product-grid-container");n&&n.scrollIntoView({behavior:"smooth"})})}),a.querySelector("#logo-home-btn").addEventListener("click",o=>{o.preventDefault(),i.setCategoryFilter("all"),window.scrollTo({top:0,behavior:"smooth"})})}function $(a,e,i){a.innerHTML=`
  ...
  `,a.querySelectorAll(".category-card").forEach(r=>{r.addEventListener("click",()=>{let s=r.getAttribute("data-category");e.setCategoryFilter(s);let l=document.getElementById("product-grid-container");l&&l.scrollIntoView({behavior:"smooth"})})})}function F(a,e,i){let r=1,s={stage:"pregnant",concern:"stretch-marks",preference:"butter"},l=[{step:1,title:"Who are you shopping for today?",subtitle:"Select the stage to help us personalize safe, biocompatible ingredients.",options:[{key:"stage",value:"pregnant",title:"Expecting Mother",desc:"Trimesters 1, 2, or 3 (Prenatal Care)",icon:"\u{1F930}"},{key:"stage",value:"postpartum",title:"Postpartum Mother",desc:"4th Trimester recovery & breastfeeding",icon:"\u{1F931}"},{key:"stage",value:"newborn",title:"Newborn Infant",desc:"0 to 6 months delicate skin",icon:"\u{1F476}"},{key:"stage",value:"toddler",title:"Baby & Toddler",desc:"6 months+ active bath & play care",icon:"\u{1F37C}"}]},{step:2,title:"What is your main skin or care focus?",subtitle:"Our certified herbal formulas target specific developmental milestones.",options:[{key:"concern",value:"stretch-marks",title:"Stretch Marks & Deep Elasticity",desc:"Soothe tight, itchy stretching skin",icon:"\u2728"},{key:"concern",value:"nursing-comfort",title:"Nursing & Nipple Healing",desc:"100% Ingestion-safe, lanolin-free balm",icon:"\u{1F496}"},{key:"concern",value:"baby-eczema",title:"Baby Dryness & Eczema",desc:"Tear-free colloidal oat barrier soothing",icon:"\u{1F6C1}"},{key:"concern",value:"sleep-calm",title:"Bedtime Sleep & Colic Relief",desc:"Lavender calming massage and sleep mist",icon:"\u{1F319}"}]},{step:3,title:"What texture and finish do you prefer?",subtitle:"All products are 100% non-sticky and fast-absorbing.",options:[{key:"preference",value:"butter",title:"Rich Whipped Body Butters",desc:"Deep 24hr moisture lock",icon:"\u{1F9C8}"},{key:"preference",value:"oil",title:"Silky Cold-Pressed Oils",desc:"Fast penetration with radiant glow",icon:"\u{1F4A7}"},{key:"preference",value:"wash-lotion",title:"Gentle Foams & Daily Lotions",desc:"Lightweight everyday hydration",icon:"\u{1F9F4}"},{key:"preference",value:"full-bundle",title:"Complete Complete Care Routine",desc:"Head-to-toe bundle with 15% savings",icon:"\u{1F381}"}]}];function h(){return s.stage==="pregnant"||s.concern==="stretch-marks"?{title:"The Ultimate Prenatal Elasticity Routine",desc:"Designed to maximize skin flexibility and lock in cellular moisture from trimester 1 through postpartum.",products:[e.products.find(t=>t.id===0x38d7eccd55b1f)||e.products[0],e.products.find(t=>t.id===0x38d7ecccd8df1)||e.products[1],e.products.find(t=>t.id===0x38d7eccd55b1d)||e.products[5]]}:s.stage==="postpartum"||s.concern==="nursing-comfort"?{title:"The Fourth Trimester Mama Recovery Routine",desc:"Hospital-grade clean soothing formulas for nursing nipples, restorative firming, and perineal recovery.",products:[e.products.find(t=>t.id===0x38d7eccd55b1e)||e.products[2],e.products.find(t=>t.id===0x38d7eccd55b27)||e.products[3],e.products.find(t=>t.id===0x38d7eccd55b18)||e.products[17]]}:s.concern==="sleep-calm"?{title:"The Blissful Baby Sleep & Calming Ritual",desc:"Pediatrician-tested nighttime ritual with organic French Lavender to encourage deep, tranquil infant sleep.",products:[e.products.find(t=>t.id===0x38d7eccd55b20)||e.products[7],e.products.find(t=>t.id===0x38d7eccd55b28)||e.products[8],e.products.find(t=>t.id===0x38d7eccd55b23)||e.products[13]]}:{title:"The Pure Newborn Head-to-Toe Starter Routine",desc:"Ultra-mild, tear-free essentials to protect baby's delicate microbiome and natural moisture barrier.",products:[e.products.find(t=>t.id===0x38d7eccd55b20)||e.products[7],e.products.find(t=>t.id===0x38d7eccd55b26)||e.products[9],e.products.find(t=>t.id===0x38d7eccd55b25)||e.products[11]]}}function m(){if(r<=3){let t=l[r-1],o=r/3*100;a.innerHTML=`
      ...
      `,a.querySelectorAll(".quiz-option").forEach(n=>{n.addEventListener("click",()=>{let p=n.getAttribute("data-key"),y=n.getAttribute("data-value");s[p]=y,m()})}),a.querySelector("#quiz-next-btn").addEventListener("click",()=>{r++,m()});let c=a.querySelector("#quiz-prev-btn");c&&c.addEventListener("click",()=>{r--,m()})}else{let t=h(),o=t.products.reduce((c,n)=>c+parseFloat((n==null?void 0:n.price)||0),0),d=(o*.85).toFixed(2);a.innerHTML=`
        <div class="container">
          <div class="quiz-section">
            <div class="quiz-card quiz-result-box">
              ...
              <div class="quiz-bundle-action">
                <div class="bundle-pricing">
                  ...
                  <span class="bundle-price-was">${i.formatPrice(o)}</span>
      ...
      `,a.querySelector("#quiz-retake-btn").addEventListener("click",()=>{r=1,m()}),a.querySelector("#quiz-add-bundle-btn").addEventListener("click",()=>{t.products.forEach(c=>{i.addToCart(c,1)}),i.toggleCart(!0)})}}m()}function S(a,e,i){let r=[{id:"all",label:"All Products (18)"},{id:"mother-care",label:"Mother Skin Care"},{id:"baby-care",label:"Baby Care"},{id:"bundles",label:"Bundles & Gift Sets"}],s=[...e.products];if(e.activeCategory&&e.activeCategory!=="all"&&(s=s.filter(t=>t.category===e.activeCategory)),e.searchQuery){let t=e.searchQuery.toLowerCase();s=s.filter(o=>o.title.toLowerCase().includes(t)||o.tags.toLowerCase().includes(t)||o.short_description.toLowerCase().includes(t))}e.sortBy==="price-low"?s.sort((t,o)=>parseFloat(t.price)-parseFloat(o.price)):e.sortBy==="price-high"?s.sort((t,o)=>parseFloat(o.price)-parseFloat(t.price)):e.sortBy==="rating"&&s.sort((t,o)=>o.rating-t.rating),a.innerHTML=`
      ...
      <div class="container">
        ...
        `:`
          <div class="products-grid">
            ${s.map(t=>{var c,n;let o=t.image||((c=t.images)==null?void 0:c[0]),d=((n=t.images)==null?void 0:n[1])||o;return`
  ...
  `,a.querySelectorAll(".filter-tab").forEach(t=>{t.addEventListener("click",()=>{let o=t.getAttribute("data-tab");i.setCategoryFilter(o)})});let l=a.querySelector("#product-sort-select");l&&l.addEventListener("change",t=>{i.setSortBy(t.target.value)});let h=a.querySelector("#clear-search-btn");h&&h.addEventListener("click",()=>{i.searchProducts("")});let m=a.querySelector("#reset-filter-btn");m&&m.addEventListener("click",()=>{i.setCategoryFilter("all"),i.searchProducts("")}),a.querySelectorAll("[data-quickview]").forEach(t=>{t.addEventListener("click",o=>{o.stopPropagation();let d=t.getAttribute("data-quickview"),c=e.products.find(n=>String(n.id)===String(d));c&&i.openProductModal(c)})}),a.querySelectorAll(".product-card").forEach(t=>{t.addEventListener("click",o=>{if(o.target.closest("[data-add-to-cart]"))return;let d=t.getAttribute("data-product-id"),c=e.products.find(n=>String(n.id)===String(d));c&&i.openProductModal(c)})}),a.querySelectorAll(".product-image-box").forEach(t=>{let o=t.querySelector(".product-img"),d=o.getAttribute("data-main"),c=o.getAttribute("data-hover");c&&c!==d&&(t.addEventListener("mouseenter",()=>{o.src=c}),t.addEventListener("mouseleave",()=>{o.src=d}))}),a.querySelectorAll("[data-add-to-cart]").forEach(t=>{t.addEventListener("click",o=>{o.stopPropagation();let d=t.getAttribute("data-add-to-cart"),c=e.products.find(n=>String(n.id)===String(d));c&&(i.addToCart(c,1),i.toggleCart(!0))})})}function _(a,e,i,r){var t,o;if(!e){a.innerHTML="";return}let s=((t=e.variants)==null?void 0:t[0])||{id:1,title:"Standard",price:e.price},l=1,h=e.image||((o=e.images)==null?void 0:o[0]);function m(){a.innerHTML=`
          ...
          <div class="quickview-grid">
            ...
            <div class="quickview-info">
              ...
              <div class="quickview-price-box">
                <span class="quickview-price">${r.formatPrice(s.price||e.price)}</span>
                ${e.compare_at_price?`
                  <span class="quickview-compare-price">${r.formatPrice(s.compare_at_price||e.compare_at_price)}</span>
                `:""}
              </div>
              ...
              ${e.variants&&e.variants.length>1?`
                <div class="variant-options-group">
                  ...
                  <div class="variant-chips">
                    ${e.variants.map(p=>`
                      <button 
                        class="variant-chip ${p.id===s.id?"selected":""}" 
              ...
              <div style="display: flex; gap: 14px; align-items: center; margin: 24px 0;">
                ...
                <button class="btn-primary" id="modal-add-cart-btn" style="flex-grow: 1;">
                  <span>\u{1F6D2} Add to Cart \u2022 ${r.formatPrice((parseFloat(s.price||e.price)*l).toFixed(2))}</span>
                </button>
              </div>
    ...
    `;let d=a.querySelector("#product-modal-overlay"),c=a.querySelector("#modal-close-btn"),n=()=>{r.closeProductModal()};c.addEventListener("click",n),d.addEventListener("click",p=>{p.target===d&&n()}),a.querySelectorAll(".thumb-img").forEach(p=>{p.addEventListener("click",()=>{h=p.getAttribute("data-src"),m()})}),a.querySelectorAll(".variant-chip").forEach(p=>{p.addEventListener("click",()=>{let y=parseInt(p.getAttribute("data-variant-id"));s=e.variants.find(w=>w.id===y)||s,m()})}),a.querySelector("#modal-qty-minus").addEventListener("click",()=>{l>1&&(l--,m())}),a.querySelector("#modal-qty-plus").addEventListener("click",()=>{l++,m()}),a.querySelector("#modal-add-cart-btn").addEventListener("click",()=>{r.addToCart(e,l,s),r.closeProductModal(),r.toggleCart(!0)})}m()}function b(a,e,i){let r=e.isCartOpen,s=e.cart.reduce((u,g)=>u+parseFloat(g.price)*g.quantity,0),l=0;e.appliedPromo==="MOMCARE15"?l=s*.15:e.appliedPromo==="PUREBABY"&&(l=Math.min(10,s));let h=Math.max(0,s-l),m=50,t=Math.min(100,s/m*100),o=Math.max(0,m-s);a.innerHTML=`
    <!-- Overlay -->
    ...
    <div class="cart-drawer ${r?"open":""}">
      ...
      <div class="free-shipping-tracker">
        <div class="free-shipping-text">
          ${o===0?"\u{1F389} You have unlocked <strong>FREE Standard Shipping!</strong>":`Add <strong>${i.formatPrice(o.toFixed(2))}</strong> more for <strong>FREE Shipping!</strong>`}
        </div>
      ...
      ${e.cart.length>0?`
        <div class="cart-footer">
          ...
          <div class="cart-summary-row">
            ...
            <span>${o===0?"FREE":i.formatPrice("4.99")}</span>
          </div>

          <div class="cart-total-row">
            <span>Total</span>
            <span>${i.formatPrice((h+(o===0?0:4.99)).toFixed(2))}</span>
          </div>
  ...
  `,a.querySelector("#guide-newsletter-form").addEventListener("submit",r=>{r.preventDefault(),alert("\u{1F389} Thank you! Your free Mother & Baby Care Routine Guide has been sent to your email."),r.target.reset()}),e.querySelectorAll("[data-footer-filter]").forEach(r=>{r.addEventListener("click",s=>{s.preventDefault();let l=r.getAttribute("data-footer-filter");i.setCategoryFilter(l);let h=document.getElementById("product-grid-container");h&&h.scrollIntoView({behavior:"smooth"})})}),e.querySelectorAll("[data-footer-nav]").forEach(r=>{r.addEventListener("click",s=>{s.preventDefault();let l=document.getElementById("routine-quiz-container");l&&l.scrollIntoView({behavior:"smooth"})})}),e.querySelectorAll("[data-page]").forEach(r=>{r.addEventListener("click",s=>{s.preventDefault();let l=r.getAttribute("data-page");i.openPageModal(l)})}),e.querySelector("#footer-admin-btn").addEventListener("click",()=>{i.openAdminHub()})}function B(a,e,i){if(!e){a.innerHTML="";return}let r={"routine-guide":{title:"Mother & Baby Care Routine Guide",subtitle:"Gentle, Biocompatible Daily Rituals for Mama and Child",content:`
      ...
      `}},s=r[e]||r["routine-guide"];a.innerHTML=`
  ...
  `;let r=a.querySelector("#admin-hub-overlay"),s=a.querySelector("#admin-hub-close-btn"),l=()=>i.closeAdminHub();s&&s.addEventListener("click",l),r&&r.addEventListener("click",n=>{n.target===r&&l()});let h=a.querySelector("#btn-sync-catalog-action"),m=a.querySelector("#sync-catalog-status");h.addEventListener("click",async()=>{h.disabled=!0,h.innerHTML="<span>\u23F3 Syncing to ShopBase...</span>",m.style.color="var(--color-primary)",m.textContent="Updating 18 products via Admin REST API...";try{let p=await(await fetch("/api/sync-catalog",{method:"POST"})).json();p.success?(m.style.color="#2E7D32",m.textContent=`\u2705 ${p.message}`,h.innerHTML="<span>\u2713 Synced Successfully</span>"):(m.style.color="#D32F2F",m.textContent=`\u274C ${p.error||"Sync failed"}`,h.innerHTML="<span>Retry Sync</span>",h.disabled=!1)}catch(n){m.style.color="#D32F2F",m.textContent=`\u274C Network Error: ${n.message}`,h.innerHTML="<span>Retry Sync</span>",h.disabled=!1}});let t=a.querySelector("#btn-sync-pages-action"),o=a.querySelector("#sync-pages-status");t.addEventListener("click",async()=>{t.disabled=!0,t.innerHTML="<span>\u23F3 Syncing Pages...</span>",o.style.color="var(--color-primary)",o.textContent="Publishing Routine Guide & Clean Safety Standards...";try{let p=await(await fetch("/api/sync-pages",{method:"POST"})).json();p.success?(o.style.color="#2E7D32",o.textContent="\u2705 Pages published to ShopBase store!",t.innerHTML="<span>\u2713 Pages Synced</span>"):(o.style.color="#D32F2F",o.textContent=`\u274C ${p.error||"Pages sync failed"}`,t.innerHTML="<span>Retry Sync</span>",t.disabled=!1)}catch(n){o.style.color="#D32F2F",o.textContent=`\u274C Network Error: ${n.message}`,t.innerHTML="<span>Retry Sync</span>",t.disabled=!1}});let d=a.querySelector("#btn-sync-homepage-action"),c=a.querySelector("#sync-homepage-status");d.addEventListener("click",async()=>{d.disabled=!0,d.innerHTML="<span>\u23F3 Syncing Homepage...</span>",c.style.color="var(--color-primary)",c.textContent="Updating homepage sections in ShopBase theme...";try{let p=await(await fetch("/api/sync-homepage",{method:"POST"})).json();p.success?(c.style.color="#2E7D32",c.textContent=`\u2705 ${p.message}`,d.innerHTML="<span>\u2713 Homepage Synced</span>"):(c.style.color="#D32F2F",c.textContent=`\u274C ${p.error||"Homepage sync failed"}`,d.innerHTML="<span>Retry Sync</span>",d.disabled=!1)}catch(n){c.style.color="#D32F2F",c.textContent=`\u274C Network Error: ${n.message}`,d.innerHTML="<span>Retry Sync</span>",d.disabled=!1}})}var I={USD:{symbol:"$",rate:1},EUR:{symbol:"\u20AC",rate:.92},GBP:{symbol:"\xA3",rate:.79},INR:{symbol:"\u20B9",rate:83.5},CAD:{symbol:"CA$",rate:1.36},AUD:{symbol:"AU$",rate:1.52}},P=class{constructor(){this.state={products:D.MOTHER_AND_BABY_PRODUCTS,activeCategory:"all",currency:"USD",searchQuery:"",sortBy:"featured",cart:JSON.parse(localStorage.getItem("corencore_cart")||"[]"),isCartOpen:!1,activeModalProduct:null,activePageKey:null,isAdminHubOpen:!1,appliedPromo:localStorage.getItem("corencore_promo")||null,quizStep:1,quizAnswers:{}},this.dom={},this.actions={setCurrency:this.setCurrency.bind(this),formatPrice:this.formatPrice.bind(this),setCategoryFilter:this.setCategoryFilter.bind(this),searchProducts:this.searchProducts.bind(this),setSortBy:this.setSortBy.bind(this),toggleCart:this.toggleCart.bind(this),addToCart:this.addToCart.bind(this),updateCartQuantity:this.updateCartQuantity.bind(this),removeFromCart:this.removeFromCart.bind(this),applyPromo:this.applyPromo.bind(this),proceedToCheckout:this.proceedToCheckout.bind(this),openProductModal:this.openProductModal.bind(this),closeProductModal:this.closeProductModal.bind(this),openPageModal:this.openPageModal.bind(this),closePageModal:this.closePageModal.bind(this),openAdminHub:this.openAdminHub.bind(this),closeAdminHub:this.closeAdminHub.bind(this)}}init(){console.log("\u{1F338} Core & Core Mother & Baby Storefront Loaded on Live ShopBase"),this.bindDom(),this.render()}bindDom(){this.dom={header:document.getElementById("header-container"),hero:document.getElementById("hero-container"),trustBar:document.getElementById("trust-bar-container"),categories:document.getElementById("categories-container"),routineQuiz:document.getElementById("routine-quiz-container"),productGrid:document.getElementById("product-grid-container"),safetyStandards:document.getElementById("safety-standards-container"),reviews:document.getElementById("reviews-container"),guideBanner:document.getElementById("guide-banner-container"),footer:document.getElementById("footer-container"),cartDrawer:document.getElementById("cart-drawer-root"),productModal:document.getElementById("product-modal-root"),pagesModal:document.getElementById("pages-modal-root"),adminHub:document.getElementById("admin-hub-root")}}setCurrency(e){this.state.currency=e,this.render()}formatPrice(e){let i=parseFloat(e)||0,r=I[this.state.currency]||I.USD,s=(i*r.rate).toFixed(2);return`${r.symbol}${s}`}setCategoryFilter(e){this.state.activeCategory=e,S(this.dom.productGrid,this.state,this.actions),f(this.dom.header,this.state,this.actions)}searchProducts(e){this.state.searchQuery=e,S(this.dom.productGrid,this.state,this.actions)}setSortBy(e){this.state.sortBy=e,S(this.dom.productGrid,this.state,this.actions)}toggleCart(e){this.state.isCartOpen=e,b(this.dom.cartDrawer,this.state,this.actions)}addToCart(e,i=1,r=null){var m,t;let s=r||((m=e.variants)==null?void 0:m[0])||{id:1,title:"Standard",price:e.price},l=`${e.id}-${s.id}`,h=this.state.cart.findIndex(o=>o.cartItemId===l);h>-1?this.state.cart[h].quantity+=i:this.state.cart.push({cartItemId:l,id:e.id,variantId:s.id,shopbaseHandle:e.shopbase_handle||e.handle,title:e.title,variantTitle:s.title!=="Standard"&&s.title!=="1 PC"?s.title:"",price:s.price||e.price,image:e.image||((t=e.images)==null?void 0:t[0]),quantity:i}),this.saveCart(),f(this.dom.header,this.state,this.actions),b(this.dom.cartDrawer,this.state,this.actions)}updateCartQuantity(e,i){let r=this.state.cart.find(s=>s.cartItemId===e);if(r&&(r.quantity+=i,r.quantity<=0)){this.removeFromCart(e);return}this.saveCart(),f(this.dom.header,this.state,this.actions),b(this.dom.cartDrawer,this.state,this.actions)}removeFromCart(e){this.state.cart=this.state.cart.filter(i=>i.cartItemId!==e),this.saveCart(),f(this.dom.header,this.state,this.actions),b(this.dom.cartDrawer,this.state,this.actions)}saveCart(){localStorage.setItem("corencore_cart",JSON.stringify(this.state.cart))}applyPromo(e){this.state.appliedPromo=e,localStorage.setItem("corencore_promo",e),b(this.dom.cartDrawer,this.state,this.actions)}proceedToCheckout(){if(!this.state.cart.length)return;let e=this.state.cart[0],i=e.shopbaseHandle||e.handle;i?window.location.href=`/products/${i}`:window.location.href="/collections/all"}openProductModal(e){this.state.activeModalProduct=e,_(this.dom.productModal,e,this.state,this.actions)}closeProductModal(){this.state.activeModalProduct=null,_(this.dom.productModal,null,this.state,this.actions)}openPageModal(e){this.state.activePageKey=e,B(this.dom.pagesModal,e,this.actions)}closePageModal(){this.state.activePageKey=null,B(this.dom.pagesModal,null,this.actions)}openAdminHub(){this.state.isAdminHubOpen=!0,k(this.dom.adminHub,this.state,this.actions)}closeAdminHub(){this.state.isAdminHubOpen=!1,k(this.dom.adminHub,this.state,this.actions)}render(){f(this.dom.header,this.state,this.actions),$(this.dom.hero,this.dom.trustBar,this.actions),A(this.dom.categories,this.actions),F(this.dom.routineQuiz,this.state,this.actions),S(this.dom.productGrid,this.state,this.actions),L(this.dom.safetyStandards),T(this.dom.reviews),H(this.dom.guideBanner,this.dom.footer,this.actions),b(this.dom.cartDrawer,this.state,this.actions),_(this.dom.productModal,this.state.activeModalProduct,this.state,this.actions),B(this.dom.pagesModal,this.state.activePageKey,this.actions),k(this.dom.adminHub,this.state,this.actions)}};function Z(){let a=window.location.pathname.toLowerCase().trim();return a==="/"||a===""||a==="/index.html"}var R=!1;function v(){if(!Z()||R&&document.getElementById("corencore-storefront-root"))return;if(!document.getElementById("corencore-fonts")){let r=document.createElement("link");r.id="corencore-fonts",r.rel="stylesheet",r.href="https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,400..800;1,400..800&family=Plus+Jakarta+Sans:wght@300;400;500;600;700;800&display=swap",document.head.appendChild(r)}document.title="Core & Core \u2014 Pure Mother & Baby Care";let a=document.getElementById("corencore-storefront-root");a||(a=document.createElement("div"),a.id="corencore-storefront-root",a.innerHTML=`
    ...
    `,document.body.appendChild(a));let e=document.createElement("style");e.id="corencore-hide-default",e.textContent=`
    #app > .theme-header,
    #app > .theme-footer,
    #app > .theme-main,
    #app > main,
  ...
  `,document.getElementById("corencore-hide-default")||document.head.appendChild(e),new P().init(),R=!0}function z(){v(),setTimeout(v,500),setTimeout(v,1500),window.addEventListener("popstate",v),window.addEventListener("hashchange",v)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",z):z();return Y(J);})();
